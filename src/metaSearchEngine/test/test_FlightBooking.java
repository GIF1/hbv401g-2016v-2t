...
public class test_FlightBooking {
	...
	public void postnrLoc() {
		Flight mittflug1 = new Flight("AAV321", "2016-03-22 23:30:00", "551 Sauðarkrókur", "Reykjavík", 12000, wow_info);
		FlightBooking.testInput(mittflug1);
	}

	@Test(expected=IllegalArgumentException.class)
	public void longLoc() {
		Flight mittflug1 = new Flight("AAV321", "2016-03-22 23:30:00", "Akureyri", "Hann var mikill maður vexti og "
	...
	public void validDealerInfo() {
		Flight mittflug = new Flight("AAV321", "2016-03-22 23:30:00", "Akureyri", "Reykjavík", 10000, wow_info);
		FlightBooking.testInput(mittflug);
	}
